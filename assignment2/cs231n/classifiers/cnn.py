...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        hidden_out, hidden_cache = affine_relu_forward(conv_relu_pool_out, self.params['W2'], self.params['b2'])
        ...
        _, grads['W1'], grads['b1'] = conv_relu_pool_backward(dconv, conv_relu_pool_cache)
